...
public interface IModbus4jWriteService {
     ...
     */
    Boolean WriteCoil(int slaveId, int writeOffset, boolean writeValue) throws ModbusTransportException;
     ...
     * @throws ModbusInitException
     */
    void WriteHoldingRegister(int slaveId, int offset, Number value, int dataType) throws ErrorResponseException, ModbusTransportException;
}
