 ...
 * 切面定义
 * <p>
 * 在{@link MyAspect2}切面类中，定义了before、after、afterReturning、afterThrowing这四个方法，并且在方法上面标记了正则式，如下：
 * </p>
 * <p>
...
public class MyAspect2 {
    ...
    public void around(ProceedingJoinPoint jp) throws Throwable {
        System.out.println(this.getClass().getName() + " ----> " + "around before...");
        jp.proceed();
        System.out.println(this.getClass().getName() + " ----> " + "around after...");
    }
}
